...
public class GoogleCustomSearch {
    ...
    private int num;
    private int start = 1;
    private static final Logger log = JDALogger.getLog("GoogleCustomSearch");
    ...
    private String getUri(String query) {
        ...
        return (sub.replace("https://www.googleapis.com/customsearch/v1?key=${key}&cx=${cx}" +
                "&q=${query}") + "&start=" + getStart() + "&alt=json");
    }
